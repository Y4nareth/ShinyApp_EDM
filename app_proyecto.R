...
mensaje <- "This is a test\n\nYou can only use this files:\n\n· Prueba1\n• Prueba2\n\nwww.google.com"

# Define UI for application that draws a histogram
ui <- fluidPage(
    
    # App title ----
    titlePanel("Proyecto Shiny EDM"),
    ...
    actionButton("close", "Close window",
                 ...
                 class="bottomAlign"),
    useShinyalert(),
    actionButton("info", "Info", style="color:black;background-color:#02C39A")
...
server <- function(input, output) {
    ...
    observeEvent(input$info, {
        ...
        shinyalert("Suggestions", mensaje, type = "info")
    })
